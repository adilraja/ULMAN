...
public class TelnetScriptExample extends TelnetAdapter {
    ...
    public TelnetScriptExample(String hostname) throws IOException, TelnetException {
        ...
        System.out.println("Note: this must match your servers login prompt exactly");
        ...
        System.out.println("Note: this must match your servers password prompt exactly");
	...
	System.out.println("Note: this must match your servers shell prompt exactly");
        System.out.print("Enter shell prompt - (e.g. $): ");
        shellPrompt = reader.readLine();
        
        System.out.println("");
        System.out.print("Enter command to run after successful login (e.g. ls -al): ");
